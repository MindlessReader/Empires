...
execute at @e[tag=red_sand] run scoreboard players add @e[tag=detector,distance=0..10] sand 1
execute at @e[tag=red_sand] run scoreboard players add @e[tag=detector,distance=0..10] block 1
