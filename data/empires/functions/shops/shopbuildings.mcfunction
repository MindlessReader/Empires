...
execute as @a[scores={shopBuildings1=132,production=40..},advancements={empires:technology/machinery=true}] at @s run tellraw @p {"text":"[Shop] You bought (1) Windmill.","color":"yellow","italic":"true"}
