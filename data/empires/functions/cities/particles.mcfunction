...
execute at @e[tag=particlestoggled,tag=city,team=aqua] run particle dust 0.122 0.973 1.000 4 ^ ^1 ^80 0 0 0 0 1 force @a
...
execute at @e[tag=particlestoggled,tag=city,team=darkred] run particle dust 0.702 0.008 0.008 4 ^ ^1 ^80 0 0 0 0 1 force
execute at @e[tag=particlestoggled,tag=city,team=gold] run particle dust 0.941 0.753 0.000 4 ^ ^1 ^80 0 0 0 0 1 force @a
execute at @e[tag=particlestoggled,tag=city,team=gray] run particle dust 0.780 0.780 0.780 4 ^ ^1 ^80 0 0 0 0 1 force @a
execute at @e[tag=particlestoggled,tag=city,team=green] run particle dust 0.314 1.000 0.020 4 ^ ^1 ^80 0 0 0 0 1 force @a
execute at @e[tag=particlestoggled,tag=city,team=lightpurple] run particle dust 1.000 0.000 0.933 4 ^ ^1 ^80 0 0 0 0 1 force @a
execute at @e[tag=particlestoggled,tag=city,team=red] run particle dust 1.000 0.000 0.000 4 ^ ^1 ^80 0 0 0 0 1 force @a
execute at @e[tag=particlestoggled,tag=city,team=yellow] run particle dust 0.933 1.000 0.000 4 ^ ^1 ^80 0 0 0 0 1 force @a
execute at @e[tag=particlestoggled,tag=city,team=open] run particle dust 1.000 1.000 1.000 4 ^ ^1 ^80 0 0 0 0 1 force @a

execute at @e[tag=particlestoggled,tag=city,team=darkblue] run particle dust 0.071 0.027 0.678 400 ~0 128 ~80 25 0 0 0 1 force @a
execute at @e[tag=particlestoggled,tag=city,team=darkblue] run particle dust 0.071 0.027 0.678 400 ~0 128 ~-80 25 0 0 0 1 force @a
execute at @e[tag=particlestoggled,tag=city,team=darkblue] run particle dust 0.071 0.027 0.678 400 ~80 128 ~0 0 0 25 0 1 force @a
execute at @e[tag=particlestoggled,tag=city,team=darkblue] run particle dust 0.071 0.027 0.678 400 ~-80 128 ~0 0 0 25 0 1 force @a
